...
<A HREF="javascript:window.print()" class="btn btn-success btn-sm btn-flat"><span class="glyphicon glyphicon-print"></span>Print</a>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, teachers.id AS empid FROM teachers LEFT JOIN subject ON subject.id=teachers.subject_id LEFT JOIN schedules ON schedules.id=teachers.schedule_id";
