...
<div class="wrapper">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    $sql = "SELECT *, teachers.id AS empid FROM teachers LEFT JOIN schedules ON schedules.id=teachers.schedule_id";
  ...
  <?php include 'includes/teacher_schedule_modal.php'; ?>
</div>
