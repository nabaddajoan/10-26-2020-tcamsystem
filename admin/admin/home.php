      ...
      <!-- /.row --><!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <?php
                $sql = "SELECT * FROM attendance_report where month(date) = '$month' and year(date) = '$year' ";
                $query = $conn->query($sql);
                $total = $query->num_rows;

                $sql = "SELECT * FROM attendance_report WHERE month = '$month'and status != 'missed' and year(date) = '$year'";
                $query = $conn->query($sql);
              ...
              <p>Monthly Attandance Percentage</p>
            </div>
            <div class="icon">
        ...
        <div class="col-lg-2 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
             $sql = "SELECT * FROM attendance_report WHERE date = '$today' AND status = 'missed' and weekend = '0' ";
...
<?php
  ...
  $late = array();
  for( $m = 1; $m <= 12; $m++ ) {
    $sql = "SELECT * FROM attendance_report WHERE MONTH(date) = '$m' and status != 'missed'  $and";
    $oquery = $conn->query($sql);
    array_push($ontime, $oquery->num_rows);
     $sql = "SELECT * FROM attendance_report WHERE month = '$m' and year = 2020 AND status = 'missed' ";
